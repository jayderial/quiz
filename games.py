...
questions = ["47 x 6 = ?","24 + 39 x 3 = ?","32 x 4 + 50 = ?","48 + 88 x 7 = ?","245 x 10 - 1986 = ?"]
options = [['209','198','289','282','282'],['141','301','255','167','141'],
           ['120','267','178','69','178'],['500','664','790','389','664'],['400','150','991','464','464']]


frame = tk.Frame(root, padx=10, pady=10,bg='#fff')
question_label = tk.Label(frame,height=7, width=28,bg='grey',fg="#fff", 
...
button_next = tk.Button(frame, text='Next',bg='Gray', font=('Verdana', 20), 
    ...
    if index == len(options):
       ...
       if correct >= len(options)/2:
        ...
        if index == len(options) - 1:
            button_next['text'] = 'Check the Score'
